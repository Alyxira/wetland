...
!function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("@pixi/utils"), require("@pixi/math"), require("@pixi/core"), require("@pixi/display")) : "function" == typeof define && define.amd ? define(["exports", "@pixi/utils", "@pixi/math", "@pixi/core", "@pixi/display"], e) : e(((t = "undefined" != typeof globalThis ? globalThis : t || self).PIXI = t.PIXI || {},
    t.PIXI.live2d = t.PIXI.live2d || {}), t.PIXI.utils, t.PIXI, t.PIXI, t.PIXI)
    ...
    class _ extends e.EventEmitter {
        ...
        setExpression(t) {
            return __async(this, null, (function*() {
                if ("number" != typeof t && (t = this.getExpressionIndex(t)),
                ...
                return !(!e || this.reserveExpressionIndex !== t) && (this.reserveExpressionIndex = -1,
    ...
    class x {
        ...
        getDefinedFiles() {
            const t = [];
            return this.replaceFiles((e => (t.push(e),
            e))),
            t
        }
        validateFiles(t) {
    ...
    class M {
        ...
        reserve(t, e, i) {
            if (i <= 0)
                return l.log(this.tag, "Cannot start a motion with MotionPriority.NONE."),
                !1;
            if (t === this.currentGroup && e === this.currentIndex)
                return l.log(this.tag, "Motion is already playing.", this.dump(t, e)),
                !1;
            if (t === this.reservedGroup && e === this.reservedIndex || t === this.reservedIdleGroup && e === this.reservedIdleIndex)
                return l.log(this.tag, "Motion is already reserved.", this.dump(t, e)),
                !1;
            if (1 === i) {
                if (0 !== this.currentPriority)
                    return l.log(this.tag, "Cannot start idle motion because another motion is playing.", this.dump(t, e)),
                    !1;
                if (void 0 !== this.reservedIdleGroup)
                    return l.log(this.tag, "Cannot start idle motion because another idle motion has reserved.", this.dump(t, e)),
                    !1;
                this.setReservedIdle(t, e)
            } else {
                if (i < 3) {
                    if (i <= this.currentPriority)
                        return l.log(this.tag, "Cannot start motion because another motion is playing as an equivalent or higher priority.", this.dump(t, e)),
                        !1;
                    if (i <= this.reservePriority)
                        return l.log(this.tag, "Cannot start motion because another motion has reserved as an equivalent or higher priority.", this.dump(t, e)),
                        !1
                }
        ...
        start(t, e, i, s) {
            if (1 === s) {
                if (this.setReservedIdle(void 0, void 0),
                0 !== this.currentPriority)
                    return l.log(this.tag, "Cannot start idle motion because another motion is playing.", this.dump(e, i)),
                    !1
            } else {
                if (e !== this.reservedGroup || i !== this.reservedIndex)
                    return l.log(this.tag, "Cannot start motion because another motion has taken the place.", this.dump(e, i)),
                    !1;
                this.setReserved(void 0, void 0, 0)
            }
            return !!t && (this.setCurrent(e, i, s),
            !0)
        }
        complete() {
    ...
    class C extends e.EventEmitter {
        ...
        loadMotion(t, e) {
            return __async(this, null, (function*() {
                ...
                return this.destroyed ? void 0 : (this.motionGroups[t][e] = null != s ? s : null,
                s)
            }
            ))
        }
        ...
        startMotion(e, i) {
            return __async(this, arguments, (function*(e, i, s=y.NORMAL) {
                ...
                if (!a)
                    return !1;
                let o;
                if (this.currentAudio && v.dispose(this.currentAudio),
                t.config.sound) {
                ...
                return this.state.start(n, e, i, s) ? (l.log(this.tag, "Start motion:", this.getMotionName(a)),
        ...
        stopAllMotions() {
            ...
            this.state.reset(),
            this.currentAudio && (v.dispose(this.currentAudio),
            this.currentAudio = void 0)
        }
        update(t, e) {
            var i;
            return this.isFinished() && (this.playing && (this.playing = !1,
    ...
    const w = class {
        static createXHR(t, e, i, s, r) {
            ...
            if (w.allXhrSet.add(a),
            t) {
                let e = w.xhrMap.get(t);
                e ? e.add(a) : (e = new Set([a]),
                w.xhrMap.set(t, e)),
    ...
    class V {
        ...
        set autoInteract(t) {
            t !== this._autoInteract && (t ? this.on("pointertap", G, this) : this.off("pointertap", G, this),
            this._autoInteract = t)
        }
        registerInteraction(t) {
            t !== this.interactionManager && (this.unregisterInteraction(),
            this._autoInteract && t && (this.interactionManager = t,
            t.on("pointermove", j, this)))
        }
        unregisterInteraction() {
            var t;
            this.interactionManager && (null == (t = this.interactionManager) || t.off("pointermove", j, this),
    ...
    class H extends r.Container {
        ...
        set autoUpdate(t) {
            ...
            t ? this._destroyed || (Y ? (Y.shared.add(this.onTickerUpdate, this),
            this._autoUpdate = !0) : l.warn(this.tag, "No Ticker registered, please call Live2DModel.registerTicker(Ticker).")) : (null == Y || Y.shared.remove(this.onTickerUpdate, this),
            this._autoUpdate = !1)
        }
        init(t) {
        ...
        _render(t) {
            ...
            t.state.reset();
            let e = !1;
            this.glContextID !== t.CONTEXT_UID && (this.glContextID = t.CONTEXT_UID,
            this.internalModel.updateWebGLContext(t.gl, this.glContextID),
            e = !0);
            for (let r = 0; r < this.textures.length; r++) {
                const i = this.textures[r];
                i.valid && (!e && i.baseTexture._glTextures[this.glContextID] || (t.gl.pixelStorei(WebGLRenderingContext.UNPACK_FLIP_Y_WEBGL, this.internalModel.textureFlipY),
            ...
            this.deltaTime && (this.internalModel.update(this.deltaTime, this.elapsedTime),
            this.deltaTime = 0);
    ...
    ;
    let J = Z;
    if (J.ZIP_PROTOCOL = "zip://",
    J.uid = 0,
    J.factory = (t, e) => __async(this, null, (function*() {
        const i = t.source;
        let s, r, a;
        if ("string" == typeof i && (i.endsWith(".zip") || i.startsWith(Z.ZIP_PROTOCOL)) ? (s = i.startsWith(Z.ZIP_PROTOCOL) ? i.slice(Z.ZIP_PROTOCOL.length) : i,
        r = yield E.load({
            url: s,
            type: "blob",
            target: t.live2dModel
        })) : Array.isArray(i) && 1 === i.length && i[0]instanceof File && i[0].name.endsWith(".zip") && (r = i[0],
    ...
    Live2DMotion.prototype.updateParam = function(t, e) {
        Q.call(this, t, e),
        e.isFinished() && this.onFinishHandler && (this.onFinishHandler(this),
    ...
    class it {
        ...
        update(t) {
            ...
            case 0:
                ...
                this.nextBlinkTimeLeft < 0 && (this.eyeState = 1,
                this.nextBlinkTimeLeft = this.blinkInterval + this.closingDuration + this.closedDuration + this.openingDuration + d(0, 2e3));
                break;
            case 1:
                this.setEyeParams(this.eyeParamValue + t / this.closingDuration),
                this.eyeParamValue <= 0 && (this.eyeState = 2,
                this.closedTimer = 0);
                break;
            case 2:
                this.closedTimer += t,
    ...
    class dt {
        constructor(t, e) {
            ...
            this.partsGroups = [],
            e.parts_visible && (this.partsGroups = e.parts_visible.map(( ({group: t}) => t.map(( ({id: t, link: e}) => {
                const i = new ht(t);
    ...
    const ct = class {
        ...
        static cbrt(t) {
            ...
            let s;
            return i && (e = -e),
            e === 1 / 0 ? s = 1 / 0 : (s = Math.exp(Math.log(e) / 3),
            s = (e / (s * s) + 2 * s) / 3),
            i ? -s : s
        }
    ...
    class Ct {
        static startUp(t) {
            if (yt)
                return It("CubismFramework.startUp() is already done."),
                yt;
            if (Live2DCubismCore._isStarted)
                return yt = !0,
                !0;
            if (Live2DCubismCore._isStarted = !0,
            xt = t,
        ...
        static initialize() {
            yt ? Mt ? wt("CubismFramework.initialize() skipped, already initialized.") : (Mt = !0,
            It("CubismFramework.initialize() is complete.")) : wt("CubismFramework is not started.")
        }
        static dispose() {
            yt ? Mt ? (pt.staticRelease(),
            Mt = !1,
            It("CubismFramework.dispose() is complete.")) : wt("CubismFramework.dispose() skipped, not initialized.") : wt("CubismFramework is not started.")
        }
        static isStarted() {
            return yt
        }
    ...
    var Dt = (t => (t[t.ExpressionBlendType_Add = 0] = "ExpressionBlendType_Add",
    ...
    class Bt {
        ...
        doUpdateMotion(t, e) {
            ...
            for (; s < this._motions.length; ) {
                ...
                r.isFinished() ? (r.release(),
                this._motions.splice(s, 1)) : (r.isTriggeredFadeOut() && r.startFadeOut(r.getFadeOutSeconds(), e),
                s++)
            }
            return i
        }
    ...
    g(Ut, [kt]);
    var Nt = (t => (t[t.CubismMotionCurveTarget_Model = 0] = "CubismMotionCurveTarget_Model",
    ...
    t))(Nt || {})
      , Vt = (t => (t[t.CubismMotionSegmentType_Linear = 0] = "CubismMotionSegmentType_Linear",
    ...
    var Ht = (t => (t[t.EvaluationOptionFlag_AreBeziersRistricted = 0] = "EvaluationOptionFlag_AreBeziersRistricted",
    t))(Ht || {});
    function qt(t, e, i) {
        const s = new Gt;
    ...
    function te(t, e, i) {
        ...
        for (let l = s.baseSegmentIndex; l < a; ++l)
            if (o = t.segments[l].basePointIndex + (t.segments[l].segmentType == Vt.CubismMotionSegmentType_Bezier ? 3 : 1),
            t.points[o].time > i) {
                r = l;
                break
            }
    ...
    class ee extends Et {
        ...
        doUpdateParameters(t, e, i, s) {
            ...
            for (; m < this._motionData.curveCount && f[m].type == Nt.CubismMotionCurveTarget_Parameter; ++m) {
                if (p = t.getParameterIndex(f[m].id),
                -1 == p)
                    continue;
                const r = t.getParameterValueByIndex(p);
                if (g = te(this._motionData, m, _),
                n != Number.MAX_VALUE)
            ...
            r >= this._motionData.duration && (this._isLoop ? (s.setStartTime(e),
            this._isLoopFadeIn && s.setFadeInStartTime(e)) : (this._onFinishedMotion && this._onFinishedMotion(this),
            s.setIsFinished(!0))),
            this._lastWeight = i
        }
        setIsLoop(t) {
        ...
        parse(t) {
            ...
            for (let n = 0; n < this._motionData.curveCount; ++n) {
                ...
                for (let l = 0; l < e.getMotionCurveSegmentCount(n); ) {
                    0 == l ? (this._motionData.segments[o].basePointIndex = a,
                    this._motionData.points[a] = new Gt(e.getMotionCurveSegment(n, l),e.getMotionCurveSegment(n, l + 1)),
                    a += 1,
                    l += 2) : this._motionData.segments[o].basePointIndex = a - 1;
    ...
    const ae = class {
        ...
        updateParameters(t, e) {
            ...
            case ne.EyeState_Closed:
                ...
                s >= 1 && (this._blinkingState = ne.EyeState_Opening,
                this._stateStartTimeSeconds = this._userTimeSeconds),
                i = 0;
                break;
            ...
            case ne.EyeState_Interval:
                this._nextBlinkingTime < this._userTimeSeconds && (this._blinkingState = ne.EyeState_Closing,
                this._stateStartTimeSeconds = this._userTimeSeconds),
                i = 1;
                break;
    ...
    let oe = ae;
    oe.CloseIfZero = !0;
    var ne = (t => (t[t.EyeState_First = 0] = "EyeState_First",
    ...
    class ce {
        ...
        getMaskRenderTexture() {
            let t = 0;
            if (this._maskTexture && 0 != this._maskTexture.texture && (this._maskTexture.frameNo = this._currentFrameNo,
        ...
        release() {
            ...
            this._maskTexture && (null == (e = this.gl) || e.deleteFramebuffer(this._maskTexture.texture),
            ...
            if (i > 0) {
                ...
                for (let i = 0; i < this._clippingContextListForMask.length; i++) {
                    ...
                    for (let i = 0; i < h; i++) {
                        ...
                        t.getDrawableDynamicFlagVertexPositionsDidChange(r) && (e.setIsCulling(0 != t.getDrawableCulling(r)),
                        e.setClippingContextBufferForMask(s),
                        e.drawMesh(t.getDrawableTextureIndices(r), t.getDrawableVertexIndexCount(r), t.getDrawableVertexCount(r), t.getDrawableVertexIndices(r), t.getDrawableVertices(r), t.getDrawableVertexUvs(r), t.getDrawableOpacity(r), _t.CubismBlendMode_Normal, !1))
                    }
                }
                this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, ue),
    ...
    class pe {
        ...
        setupShaderProgram(t, e, i, s, r, a, o, n, l, h, d, u, c) {
            ...
            if (null != f) {
                ...
                if (this.gl.useProgram(n.shaderProgram),
                null == o.vertex && (o.vertex = this.gl.createBuffer()),
                this.gl.bindBuffer(this.gl.ARRAY_BUFFER, o.vertex),
                this.gl.bufferData(this.gl.ARRAY_BUFFER, s, this.gl.DYNAMIC_DRAW),
        ...
        loadShaderProgram(t, e) {
            ...
            if (!s)
                return Tt("Vertex shader compile error!"),
                0;
            ...
            return this.gl.getProgramParameter(i, this.gl.LINK_STATUS) ? (this.gl.deleteShader(s),
            this.gl.deleteShader(r),
            i) : (Tt("Failed to link program: {0}", i),
    ...
    class Se extends pt {
        ...
        initialize(t) {
            t.isUsingMasking() && (this._clippingManager = new ce,
        ...
        drawMesh(t, e, i, s, r, a, o, n, l) {
            ...
            null == this.getClippingContextBufferForMask() && (h.A *= o,
            this.isPremultipliedAlpha() && (h.R *= h.A,
            h.G *= h.A,
            h.B *= h.A));
            let d = null;
    ...
    class Fe {
        static create(t) {
            const e = new Fe;
            "number" == typeof t.FadeInTime && (e._fadeTimeSeconds = t.FadeInTime,
            e._fadeTimeSeconds <= 0 && (e._fadeTimeSeconds = .5));
            const i = t.Groups
              , s = i.length;
            for (let r = 0; r < s; ++r) {
                const t = i[r]
    ...
    class Ae {
        ...
        getPartIndex(t) {
            ...
            for (e = 0; e < i; ++e)
                if (t == this._partIds[e])
                    return e;
            return t in this._notExistPartId ? this._notExistPartId[t] : (e = i + this._notExistPartId.length,
        ...
        setPartOpacityByIndex(t, e) {
            t in this._notExistPartOpacities ? this._notExistPartOpacities[t] = e : (0 <= t && this.getPartCount(),
        ...
        getPartOpacityByIndex(t) {
            return t in this._notExistPartOpacities ? this._notExistPartOpacities[t] : (0 <= t && this.getPartCount(),
        ...
        getParameterIndex(t) {
            ...
            for (e = 0; e < i; ++e)
                if (t == this._parameterIds[e])
                    return e;
            return t in this._notExistParameterId ? this._notExistParameterId[t] : (e = this._model.parameters.count + Object.keys(this._notExistParameterId).length,
        ...
        getParameterValueByIndex(t) {
            return t in this._notExistParameterValues ? this._notExistParameterValues[t] : (0 <= t && this.getParameterCount(),
        ...
        setParameterValueByIndex(t, e, i=1) {
            t in this._notExistParameterValues ? this._notExistParameterValues[t] = 1 == i ? e : this._notExistParameterValues[t] * (1 - i) + e * i : (0 <= t && this.getParameterCount(),
    ...
    var Re = (t => (t[t.CubismPhysicsTargetType_Parameter = 0] = "CubismPhysicsTargetType_Parameter",
    t))(Re || {})
      , Oe = (t => (t[t.CubismPhysicsSource_X = 0] = "CubismPhysicsSource_X",
        ...
        evaluate(t, e) {
            ...
            for (let p = 0; p < this._physicsRig.subRigCount; ++p) {
                ...
                for (let e = 0; e < n.inputCount; ++e)
                    ...
                    l[e].getNormalizedParameterValue(o, i, u[l[e].sourceParameterIndex], g[l[e].sourceParameterIndex], c[l[e].sourceParameterIndex], m[l[e].sourceParameterIndex], n.normalizationPosition, n.normalizationAngle, l[e].reflect, s);
        ...
        parse(t) {
            ...
            for (let a = 0; a < this._physicsRig.subRigCount; ++a) {
                ...
                for (let i = 0; i < t.inputCount; ++i) {
                    const t = new Ne;
                    switch (t.sourceParameterIndex = -1,
                ...
                for (let i = 0; i < t.outputCount; ++i) {
                    const t = new Ve;
                    switch (t.destinationParameterIndex = -1,
    ...
    function ii(t, e, i, s, r, a, o, n) {
        let l, h, d, u, c = new ut(0,0), g = new ut(0,0), m = new ut(0,0), p = new ut(0,0);
        ...
        for (let _ = 1; _ < e; ++_)
            ...
            0 != h && (t[_].velocity = t[_].position.substract(t[_].lastPosition),
    ...
    function si(t, e, i, s, r) {
        ...
        o = s * a,
        o < e ? (o < r.valueBelowMinimum && (r.valueBelowMinimum = o),
        o = e) : o > i && (o > r.valueExceededMaximum && (r.valueExceededMaximum = o),
        o = i),
        n = r.weight / 100,
        n >= 1 || (o = t[0] * (1 - n) + o * n),
        t[0] = o
    ...
    N.registerRuntime({
        ...
        createInternalModel(t, e, i) {
            const s = new Ie(t,e,i)
              , r = t;
            return r.__moc && (s.__moc = r.__moc,
            delete r.__moc,
            s.once("destroy", ai)),
            s
        },
